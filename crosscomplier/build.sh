...
export PREFIX="/Users/limuyang/Desktop/OS-Kernel/crosscomplier/gcc"
export TARGET=i386-elf
export PATH="$PREFIX/bin:$PATH"

cd '/Users/limuyang/Desktop/OS-Kernel/crosscomplier'
mkdir /tmp/src
cd /tmp/src
...
cd '/Users/limuyang/Desktop/OS-Kernel/crosscomplier'
cd /tmp/src
curl -O https://ftp.gnu.org/gnu/gcc/gcc-8.1.0/gcc-8.1.0.tar.gz
tar xf gcc-8.1.0.tar.gz
mkdir gcc-build
cd gcc-build
../gcc-8.1.0/configure --target=$TARGET --prefix="$PREFIX" --disable-nls --disable-libssp --enable-languages=c --without-headers
make all-gcc 
